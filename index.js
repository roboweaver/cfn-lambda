...
function CfnLambdaFactory(resourceDefinition) {
    ...
    return function CfnLambda(event, context) {
        ...
        /**
         * See if it's long running or ready
         * @return {CfnLambdaFactory.CfnLambda.NormalReply|Function}
         */
        ...
        /**
         * Trigger the log running resply
         * 
         * @param {type} rawReplyResponse
         * @return {undefined}
         */
 ...
 * 
 * @param {type} context
 * @return {nm$_index.getEnvironment.indexAnonym$7}
 */

...
function Composite(compositeDefinition) {
  ...
  var RunComposition = compositeDefinition.Composition;
  var TimeoutInMinutes = Math.ceil(compositeDefinition.PingInSeconds *
    compositeDefinition.MaxPings / 60) + 1;
  return CfnLambda({
    NoUpdate: NoUpdate,
    Create: Create,
    Update: Update,
    Delete: Delete,
    LongRunning: {
      PingInSeconds: compositeDefinition.PingInSeconds,
      MaxPings: compositeDefinition.MaxPings,
